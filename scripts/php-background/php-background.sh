...
PIDS="/var/www/vhosts/ns3000631.ovh.net/beta.trazeo.es/trazeo-web/scripts/php-background/pids.txt";
PROCESSES="/var/www/vhosts/ns3000631.ovh.net/beta.trazeo.es/trazeo-web/scripts/php-background/processes.txt";
